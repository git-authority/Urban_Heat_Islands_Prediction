...
indices = np.arange(n)  # chronological indices 0..n-1

# Chronological split: first (1 - val_split) -> train, last val_split -> val (no shuffle)
split_idx = int(np.floor((1.0 - val_split) * n))
